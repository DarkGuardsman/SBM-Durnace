...
import com.builtbroken.durnace.Durnace;
...
public class BlockDurnace extends BlockContainer implements ITileEntityProvider
{
    ...
    {
        return Item.getItemFromBlock(Durnace.durnace);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.openGui(Durnace.INSTANCE, 0, worldIn, pos.getX(), pos.getY(), pos.getZ());
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileDurnace)
            {
                ((TileDurnace) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new ItemStack(Durnace.durnace);
    }
